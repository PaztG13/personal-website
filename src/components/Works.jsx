        ...
        <div className="max-w-[90%] m-auto my-10 px-20 py-20 bg-gray-950 text-white rounded-4xl shadow-lg">
                <div className="sr-container max-w-[1280px] m-auto flex justify-between items-center gap-10">
                    <div className="showreel-title flex flex-col gap-5">
                        ...
                        <a href="https://www.youtube.com/watch?v=GEUC8ojOUWY" className="px-5 py-2 outline-1 w-[250px] rounded-full flex gap-3 items-center transition duration-150 ease-in-out hover:bg-white hover:outline-0 hover:text-gray-950 hover:justify-between">
                            <span>Watch on YouTube!</span>
                            <span>&#8594;</span>
                        </a>
                    </div>
                    <div className="showreel-content">
                        <iframe width="720" height="405" src="https://www.youtube.com/embed/GEUC8ojOUWY?si=uR0kwAC0G4NOZd6r" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen className="rounded-2xl outline-2 outline-offset-10"></iframe>
                    </div>
                </div>
            </div>
    )
